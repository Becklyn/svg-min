            ...
            (error, files) =>
            {
                ...
                files.forEach(
                    (filePath) =>
                    {
                        ...
                        svgFile.minify()
                            .then(data => this.storeFile(data, filePath))
    ...
    storeFile (svg, inputFilePath)
    {
        ...
        fs.writeFile(
            ...
            (error) =>
            {
                ...
                console.log(chalk`{green Minified} ${path.relative(process.cwd(), inputFilePath)} -> ${path.relative(process.cwd(), outPath)}`);
            }
        );
    }
